...
<div id="breadcrumb" class="section">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="breadcrumb-header">CADASTRO</h3>
				...
				<div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">SELEIONE O TIPO DE CADASTRO</h3>
						</div>
						<div name="tipoacesso">
							<select class="input required" onchange="changeSelect()" id="fl_tipoacesso">
					...
					<div class="billing-details col-md-6">
						...
						<div class="form-group">
						<select class="input required" id="fl_sexo">
					...
					<div class="shiping-details col-md-6">
						...
						<div class="form-group">
							<input class="input" type="text" id="tx_login" maxlength="25" placeholder="Login"><br>
						</div>
						<div class="form-group"><input class="input" type="password" id="tx_senha" maxlength="50" placeholder="Senha">
						</div>
						<div class="form-group"><input type="button" value="CADASTRE-SE" onclick="cadastrar()" class="primary-btn order-submit">
						</div>
